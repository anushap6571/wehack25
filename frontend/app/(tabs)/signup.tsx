...
export default function SignUp() {
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Text style={{fontSize: 30, color: Colors.light.darkGreen, fontWeight: '700', marginTop: 100}}>get started</Text>
            <TextInput
            ...
            <Pressable onPress={() => router.push('/input')}style={{marginTop: 40, backgroundColor: Colors.light.darkGreen, height: 55, width: 324, paddingHorizontal: 20, borderRadius: 100, justifyContent: 'center', alignItems: 'center'}}>
            ...
            <View style={{flex: 1, flexDirection: 'row', backgroundColor: 'white', top: 30, justifyContent: 'center'}}>
                ...
                <Pressable onPress={() => router.push('/login')} style={{marginLeft: 5}}>
                    <Text style={{color: Colors.light.neonGreen, fontSize: 14}}>login</Text>
                </Pressable>
            </View>
        </SafeAreaView>
    );
